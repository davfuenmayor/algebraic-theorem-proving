...
lemma "0 \<le> 1 \<and> 1 \<le> 2" by simp

lemma refl: "x \<le> x" using leq.elims(3) by blast
lemma trans: "x \<le> y \<and> y \<le> z \<longrightarrow> x \<le> z" by (metis Z\<^sub>3.simps(4) leq.elims(2) leq.elims(3))
lemma antisym: "x \<le> y \<and> y \<le> x \<longrightarrow> x = y" by (metis Z\<^sub>3.simps(4) leq.elims(2))
...
lemma lattice_distr1: "(x \<^bold>\<and> (y \<^bold>\<or> z)) = ((x \<^bold>\<and> y) \<^bold>\<or> (x \<^bold>\<and> z))" 
  by (smt (verit, best) Join.simps(1) Join.simps(2) Join.simps(3) Join.simps(4) Join.simps(5) Join.simps(6) Join.simps(7) Join.simps(8) Join.simps(9) Meet.simps(1) Meet.simps(2) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(9) Z\<^sub>3.exhaust)
lemma lattice_distr2: "(x \<^bold>\<or> (y \<^bold>\<and> z)) = ((x \<^bold>\<or> y) \<^bold>\<and> (x \<^bold>\<or> z))" 
  by (smt (verit, del_insts) AdditiveInverse.cases Join.simps(1) Join.simps(3) Join.simps(4) Join.simps(5) Join.simps(6) Join.simps(8) Join.simps(9) Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9))
...
lemma resid_law2: "RESID2 (\<^bold>\<rightharpoonup>) (\<^bold>\<or>)" sorry (*TODO: reconstruction takes too long*)
  (* by (smt (z3) DualImplication.simps(1) DualImplication.simps(2) DualImplication.simps(3) DualImplication.simps(4) DualImplication.simps(5) DualImplication.simps(6) DualImplication.simps(7) DualImplication.simps(8) DualImplication.simps(9) Join.elims Join_maxdef leq.elims(3) leq.simps(4)) *)
...
lemma "(x \<^bold>\<rightarrow> y = 2) \<longleftrightarrow> (x \<le> y)" 
  by (smt (verit, del_insts) AdditiveInverse.elims Implication.simps(1) Implication.simps(2) Implication.simps(3) Implication.simps(4) Implication.simps(5) Implication.simps(6) Implication.simps(7) Implication.simps(8) Implication.simps(9) Z\<^sub>3.simps(6) leq.elims(3) leq.simps(5) leq.simps(6) leq.simps(7))
lemma "(x \<^bold>\<leftharpoonup> y = 0) \<longleftrightarrow> (x \<le> y)"
  by (metis Join_maxdef antisym leq.simps(1) resid_law2)

(*While the following does not hold: *)
lemma "(x \<^bold>\<rightarrow> y \<ge> 1) \<longleftrightarrow> (x \<le> y)" nitpick oops (*counterexample*)
lemma "(x \<^bold>\<leftharpoonup> y \<le> 1) \<longleftrightarrow> (x \<le> y)" nitpick oops (*counterexample*)

(*The previous results justify introducing the following convenient definitions: *)
abbreviation(input) Top ("\<^bold>\<top>")    where "\<^bold>\<top> \<equiv> 2"
...
lemma Meet_polydef:            "(x \<^bold>\<and> y) = (2\<cdot>x\<^sup>2\<cdot>y\<^sup>2 + 2\<cdot>x\<^sup>2\<cdot>y     + 2\<cdot>x\<cdot>y\<^sup>2 + x\<cdot>y)" by (smt (verit, best) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(4) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) AdditiveInverse.cases Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9))
lemma Join_polydef:            "(x \<^bold>\<or> y) =   (x\<^sup>2\<cdot>y\<^sup>2 + x\<^sup>2\<cdot>y       + x\<cdot>y\<^sup>2 + 2\<cdot>x\<cdot>y + x + y)" by (smt (verit, del_insts) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(4) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) AdditiveInverse.elims Join.simps(1) Join.simps(2) Join.simps(3) Join.simps(4) Join.simps(5) Join.simps(6) Join.simps(7) Join.simps(8) Join.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9))
lemma Implication_polydef:     "(x \<^bold>\<rightarrow> y) =  (x\<^sup>2\<cdot>y\<^sup>2 + 2\<cdot>x\<^sup>2\<cdot>y + x\<^sup>2 + x\<cdot>y\<^sup>2  + x\<cdot>y         + 2)" by (smt (verit, ccfv_SIG) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(4) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) Implication.simps(1) Implication.simps(2) Implication.simps(3) Implication.simps(4) Implication.simps(5) Implication.simps(6) Implication.simps(7) Implication.simps(8) Implication.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Z\<^sub>3.exhaust)
lemma DualImplication_polydef: "(x \<^bold>\<rightharpoonup> y) = (2\<cdot>x\<^sup>2\<cdot>y\<^sup>2 + 2\<cdot>x\<cdot>y\<^sup>2             + x\<cdot>y     + y)" by (smt (verit, best) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(4) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) AdditiveInverse.cases DualImplication.simps(1) DualImplication.simps(2) DualImplication.simps(3) DualImplication.simps(4) DualImplication.simps(5) DualImplication.simps(6) DualImplication.simps(7) DualImplication.simps(8) DualImplication.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9))
...
lemma "MONO \<I>\<^sub>i \<and> DECR \<I>\<^sub>i" by (metis InteriorI.elims antisym Z\<^sub>3.distinct(3) leq.elims(3) leq.simps(4))
lemma "MONO \<I>\<^sub>n \<and> DECR \<I>\<^sub>n" by (metis InteriorN.elims Z3_order210.refl leq.simps(1) leq.simps(7)) 
...
lemma "MONO \<phi> \<longleftrightarrow> ANTI (\<^bold>\<sim> \<circ> \<phi>)" by (smt (verit, best) Negation.elims Z\<^sub>3.distinct(1) Z\<^sub>3.distinct(5) leq.elims(3) leq.simps(5) leq.simps(7)) 
lemma "MONO \<phi> \<longleftrightarrow> ANTI (\<phi> \<circ> \<^bold>\<sim>)" by (smt (verit, best) Negation.simps(1) Negation.simps(2) Negation.simps(3) leq.elims(2) leq.elims(3) leq.simps(2) leq.simps(5)) 
(*And viceversa*)
lemma "ANTI \<phi> \<longleftrightarrow> MONO (\<^bold>\<sim> \<circ> \<phi>)" by (smt (verit, best) Negation.elims Z\<^sub>3.distinct(1) Z\<^sub>3.distinct(5) leq.elims(3) leq.simps(5) leq.simps(7))
lemma "ANTI \<phi> \<longleftrightarrow> MONO (\<phi> \<circ> \<^bold>\<sim>)" by (smt (verit, best) Negation.simps(1) Negation.simps(2) Negation.simps(3) leq.elims(2) leq.elims(3) leq.simps(1) leq.simps(2))
...
lemma "\<^bold>\<frown>(\<^bold>\<frown>x) \<le> x" by (metis NegationC.simps(1) NegationC.simps(2) NegationC.simps(3) Z\<^sub>3.simps(2) Z\<^sub>3.simps(4) leq.elims(3))
...
lemma "\<^bold>\<frown>x \<^bold>\<or> x = \<^bold>\<top>" by (metis Join.simps(3) Join.simps(7) Join.simps(8) NegationC.elims)
lemma "\<^bold>\<smile>x \<^bold>\<and> x = \<^bold>\<bottom>" by (metis Meet.simps(2) Meet.simps(3) Meet.simps(7) NegationI.elims)

(*We fact in fact the following alternative definitions: *)
lemma NegationC_char2: "\<^bold>\<frown>x = (\<^bold>\<top> \<^bold>\<leftharpoonup> x)" by (metis DualImplication.simps(3) DualImplication.simps(6) DualImplication.simps(9) NegationC.elims)
lemma NegationI_char2: "\<^bold>\<smile>x = (x \<^bold>\<rightarrow> \<^bold>\<bottom>)" by (metis Implication.simps(1) Implication.simps(4) Implication.simps(7) NegationI.elims)
...
lemma ClosureN_polydef:  "\<C>\<^sub>n x = 2\<cdot>x\<^sup>2" by (smt (verit, best) Addition.simps(1) Addition.simps(2) Addition.simps(5) Addition.simps(8) Addition.simps(9) ClosureN.elims Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9))
lemma InteriorN_polydef: "\<I>\<^sub>n x = x\<^sup>2 + 2\<cdot>x" by (metis (full_types) Addition.simps(1) Addition.simps(5) Addition.simps(6) InteriorN.simps(1) InteriorN.simps(2) InteriorN.simps(3) Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Z\<^sub>3.exhaust)
lemma Negation_polydef:   "\<^bold>\<sim>x = 2\<cdot>x + 2" by (metis Addition.simps(3) Addition.simps(6) Addition.simps(9) InteriorA.elims Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Negation.simps(1) Negation.simps(2) Negation.simps(3))
lemma NegationC_polydef: "\<^bold>\<frown>x = 2\<cdot>x\<^sup>2 + x + 2" by (smt (verit, best) Addition.simps(1) Addition.simps(3) Addition.simps(6) Addition.simps(8) Addition.simps(9) Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) NegationC.elims)
lemma NegationI_polydef: "\<^bold>\<smile>x = x\<^sup>2 + 2" by (smt (verit, ccfv_threshold) Addition.simps(1) Addition.simps(3) Addition.simps(5) Addition.simps(6) Addition.simps(9) Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) NegationI.elims)
lemma Nmeet_polydef: "x \<^bold>\<up> y = x\<^sup>2\<cdot>y\<^sup>2 + x\<^sup>2\<cdot>y + x\<cdot>y\<^sup>2 + 2\<cdot>x\<cdot>y + 2" by (smt (verit) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(5) Addition.simps(6) Addition.simps(8) Addition.simps(9) InteriorI.elims Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Negation.simps(1) Negation.simps(2) Negation.simps(3))
lemma Njoin_polydef: "x \<^bold>\<down> y = 2\<cdot>x\<^sup>2\<cdot>y\<^sup>2 + 2\<cdot>x\<^sup>2\<cdot>y + 2\<cdot>x\<cdot>y\<^sup>2 + x\<cdot>y + 2\<cdot>x + 2\<cdot>y + 2" by (smt (verit) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(4) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) InteriorI.elims Join.simps(1) Join.simps(2) Join.simps(3) Join.simps(4) Join.simps(5) Join.simps(6) Join.simps(7) Join.simps(8) Join.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Negation.simps(1) Negation.simps(2) Negation.simps(3))
