...
lemma "0 \<le> 2 \<and> 2 \<le> 1" by simp

lemma refl: "x \<le> x" using leq.elims(3) by blast
lemma trans: "x \<le> y \<and> y \<le> z \<longrightarrow> x \<le> z" by (metis Z\<^sub>3.simps(2) leq.elims(2) leq.elims(3))
lemma antisym: "x \<le> y \<and> y \<le> x \<longrightarrow> x = y" by (metis Z\<^sub>3.simps(2) leq.elims(2))
...
fun Meet::"Z\<^sub>3 \<Rightarrow> Z\<^sub>3 \<Rightarrow> Z\<^sub>3" (infixl "\<^bold>\<and>" 56) where (*minimal (meet) of two values*)
  ...
  "2 \<^bold>\<and> 0 = 0" |
  "2 \<^bold>\<and> 1 = 2" |
  "2 \<^bold>\<and> 2 = 2"  (*differs here from '*' table (where 2 * 2 = 1) *)

lemma Meet_mindef: "Meet x y = (if x \<le> y then x else y)" (*double check*)
  by (smt (verit, ccfv_threshold) leq.elims(1) Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9))
...
lemma Join_maxdef: "Join x y = (if x \<le> y then y else x)" (*double check*)
  by (smt (z3) Z\<^sub>3.distinct(1) Join.elims Join.simps(1) leq.elims(3) leq.simps(5) leq.simps(6) leq.simps(7))

lemma lattice_distr1: "(x \<^bold>\<and> (y \<^bold>\<or> z)) = ((x \<^bold>\<and> y) \<^bold>\<or> (x \<^bold>\<and> z))"
  by (smt (verit, ccfv_threshold) AdditiveInverse.elims Join.simps(1) Join.simps(2) Join.simps(3) Join.simps(4) Join.simps(5) Join.simps(6) Join.simps(7) Join.simps(8) Join.simps(9) Meet.simps(1) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(7) Meet.simps(8) Meet.simps(9))
lemma lattice_distr2: "(x \<^bold>\<or> (y \<^bold>\<and> z)) = ((x \<^bold>\<or> y) \<^bold>\<and> (x \<^bold>\<or> z))" 
  by (smt (verit, ccfv_SIG) AdditiveInverse.elims Join.simps(1) Join.simps(2) Join.simps(5) Join.simps(6) Join.simps(7) Join.simps(8) Join.simps(9) Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9))
...
lemma Multiplication_char: "(a * b) = (a \<^bold>\<and> b) \<^bold>\<or> (-a \<^bold>\<and> -b)" 
  by (smt (z3) AdditiveInverse.simps(1) AdditiveInverse.simps(2) AdditiveInverse.simps(3) Join.simps(1) Join.simps(6) Join.simps(8) Join.simps(9) Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9) Multiplication.elims)
...
fun DualImplication::"Z\<^sub>3 \<Rightarrow> Z\<^sub>3 \<Rightarrow> Z\<^sub>3" (infixl "\<^bold>\<rightharpoonup>" 54) where
  ...
  "1 \<^bold>\<rightharpoonup> 2 = 0" |
  "2 \<^bold>\<rightharpoonup> 0 = 0" |
  "2 \<^bold>\<rightharpoonup> 1 = 1" |
  "2 \<^bold>\<rightharpoonup> 2 = 0"
...
lemma "(x \<^bold>\<rightarrow> y = 1) \<longleftrightarrow> (x \<le> y)"
  by (smt (z3) Implication.elims Z\<^sub>3.distinct(5) Z\<^sub>3.simps(2) Z\<^sub>3.simps(4) leq.elims(1))
...
lemma "(x \<^bold>\<rightarrow> y \<ge> 2) \<longleftrightarrow> (x \<le> y)" nitpick oops (*counterexample*)
lemma "(x \<^bold>\<leftharpoonup> y \<le> 2) \<longleftrightarrow> (x \<le> y)" nitpick oops (*counterexample*)
...
lemma Meet_polydef:            "(x \<^bold>\<and> y) =  (x\<^sup>2\<cdot>y\<^sup>2 + 2\<cdot>x\<^sup>2\<cdot>y      + 2\<cdot>x\<cdot>y\<^sup>2 + 2\<cdot>x\<cdot>y)" by (smt (z3) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(5) Addition.simps(6) Addition.simps(8) Addition.simps(9) AdditiveInverse.elims Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9))
lemma Join_polydef:            "(x \<^bold>\<or> y) = (2\<cdot>x\<^sup>2\<cdot>y\<^sup>2 +  x\<^sup>2\<cdot>y       + x\<cdot>y\<^sup>2  + x\<cdot>y  + x + y)" by (smt (verit) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(4) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) AdditiveInverse.elims Join.simps(1) Join.simps(2) Join.simps(3) Join.simps(4) Join.simps(5) Join.simps(6) Join.simps(7) Join.simps(8) Join.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9))
lemma Implication_polydef:     "(x \<^bold>\<rightarrow> y)= (2\<cdot>x\<^sup>2\<cdot>y\<^sup>2 + 2\<cdot>x\<^sup>2\<cdot>y + 2\<cdot>x\<^sup>2 + x\<cdot>y\<^sup>2 + 2\<cdot>x\<cdot>y         + 1)" by (smt (z3) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) AdditiveInverse.cases Implication.simps(1) Implication.simps(2) Implication.simps(3) Implication.simps(4) Implication.simps(5) Implication.simps(6) Implication.simps(7) Implication.simps(8) Implication.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9))
lemma DualImplication_polydef: "(x \<^bold>\<rightharpoonup> y) =  (x\<^sup>2\<cdot>y\<^sup>2             + 2\<cdot>x\<cdot>y\<^sup>2 + 2\<cdot>x\<cdot>y     + y)" by (smt (verit, best) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(5) Addition.simps(6) Addition.simps(8) Addition.simps(9) DualImplication.simps(1) DualImplication.simps(2) DualImplication.simps(3) DualImplication.simps(4) DualImplication.simps(5) DualImplication.simps(6) DualImplication.simps(7) DualImplication.simps(8) DualImplication.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Z\<^sub>3.exhaust)
...
lemma "MONO \<phi> \<longleftrightarrow> (\<forall>x y. \<phi>(x \<^bold>\<and> y) = (\<phi> x) \<^bold>\<and> (\<phi> y))" by (smt (z3) Meet_mindef linear leq.elims(1))
lemma "MONO \<phi> \<longleftrightarrow> (\<forall>x y. \<phi>(x \<^bold>\<or> y) = (\<phi> x) \<^bold>\<or> (\<phi> y))" unfolding Join_maxdef by (smt (verit, best) linear leq.elims(2))
...
lemma "MONO \<I>\<^sub>a \<and> DECR \<I>\<^sub>a" by (metis InteriorA.elims linear leq.simps(1) leq.simps(5) leq.simps(6))
lemma "MONO \<I>\<^sub>i \<and> DECR \<I>\<^sub>i" by (metis InteriorI.elims Z\<^sub>3.distinct(5) Z\<^sub>3.simps(2) Z\<^sub>3.simps(4) leq.elims(3) leq.simps(5))
lemma "MONO \<I>\<^sub>n \<and> DECR \<I>\<^sub>n" by (metis InteriorN.elims leq.elims(2) leq.simps(1) leq.simps(2)) 
...
(*We start by considering the (unique) involutive negation \<^bold>\<sim> *)
...
lemma "INVOL \<^bold>\<sim>" by (metis Negation.cases Negation.simps(1) Negation.simps(2) Negation.simps(3))
...
lemma "MONO \<phi> \<longleftrightarrow> ANTI (\<^bold>\<sim> \<circ> \<phi>)" by (smt (verit, best) Negation.elims Z\<^sub>3.distinct(3) Z\<^sub>3.distinct(5) leq.elims(3) leq.simps(6) leq.simps(7)) 
lemma "MONO \<phi> \<longleftrightarrow> ANTI (\<phi> \<circ> \<^bold>\<sim>)" by (smt (verit, del_insts) Negation.elims linear leq.simps(6) leq.simps(7)) 
(*And viceversa*)
lemma "ANTI \<phi> \<longleftrightarrow> MONO (\<^bold>\<sim> \<circ> \<phi>)" by (smt (verit, ccfv_threshold) Negation.simps(1) Negation.simps(2) Negation.simps(3) Z\<^sub>3.simps(2) leq.elims(1))
lemma "ANTI \<phi> \<longleftrightarrow> MONO (\<phi> \<circ> \<^bold>\<sim>)" by (smt (verit, best) Negation.elims Negation.simps(1) Negation.simps(3) refl leq.elims(2) leq.simps(1) leq.simps(3))
...
lemma "ANTI \<^bold>\<frown>" by (smt (verit, best) NegationC.elims Z\<^sub>3.simps(4) leq.elims(1) leq.simps(2))
lemma "ANTI \<^bold>\<smile>" by (metis NegationI.simps(1) NegationI.simps(3) Z\<^sub>3.simps(2) Z\<^sub>3.simps(4) leq.elims(2) leq.elims(3) leq.simps(2))
...
lemma "\<^bold>\<frown>(\<^bold>\<frown>x) \<le> x" by (metis NegationC.simps(1) NegationC.simps(2) NegationC.simps(3) Z\<^sub>3.distinct(1) Z\<^sub>3.distinct(3) leq.elims(3))
lemma "x \<le> \<^bold>\<smile>(\<^bold>\<smile>x)" by (metis NegationI.elims NegationI.simps(3) refl leq.simps(3))

(*As well as the following properties (algebraic counterparts of 'excluded middle' and 'ex-contradictio' *)
lemma "\<^bold>\<frown>x \<^bold>\<or> x = \<^bold>\<top>" by (metis Join.simps(2) Join.simps(4) Join.simps(6) NegationC.elims)
lemma "\<^bold>\<smile>x \<^bold>\<and> x = \<^bold>\<bottom>" by (metis AdditiveInverse.cases Meet.simps(2) Meet.simps(3) Meet.simps(4) NegationI.simps(1) NegationI.simps(2) NegationI.simps(3))
...
lemma NegationI_char2: "\<^bold>\<smile>x = (x \<^bold>\<rightarrow> \<^bold>\<bottom>)" by (metis ClosureA.elims Implication.simps(1) Implication.simps(4) Implication.simps(7) NegationI.simps(1) NegationI.simps(2) NegationI.simps(3))
...
lemma ClosureN_polydef:  "\<C>\<^sub>n x = x\<^sup>2" by (metis ClosureN.simps(1) ClosureN.simps(2) ClosureN.simps(3) Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(9) NegationI.cases)
lemma InteriorN_polydef: "\<I>\<^sub>n x = 2\<cdot>x\<^sup>2 + 2\<cdot>x" by (smt (verit, del_insts) Addition.simps(1) Addition.simps(8) Addition.simps(9) InteriorN.simps(1) InteriorN.simps(2) InteriorN.simps(3) Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) NegationC.elims)
lemma Negation_polydef:   "\<^bold>\<sim>x = 2\<cdot>x + 1" by (metis Addition.simps(2) Addition.simps(5) Addition.simps(8) AdditiveInverse.cases Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Negation.simps(1) Negation.simps(2) Negation.simps(3))
lemma NegationC_polydef: "\<^bold>\<frown>x = x\<^sup>2 + x + 1" by (smt (verit, best) Addition.simps(1) Addition.simps(2) Addition.simps(5) Addition.simps(6) Addition.simps(8) Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(9) NegationC.elims)
lemma NegationI_polydef: "\<^bold>\<smile>x = 2\<cdot>x\<^sup>2 + 1" by (metis (full_types) Addition.simps(2) Addition.simps(8) Multiplication.simps(1) Multiplication.simps(5) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) NegationI.elims)
lemma Nmeet_polydef: "x \<^bold>\<up> y = 2\<cdot>x\<^sup>2\<cdot>y\<^sup>2 + x\<^sup>2\<cdot>y + x\<cdot>y\<^sup>2 + x\<cdot>y + 1" by (smt (z3) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(5) Addition.simps(6) Addition.simps(8) Addition.simps(9) ClosureI.elims Meet.simps(1) Meet.simps(2) Meet.simps(3) Meet.simps(4) Meet.simps(5) Meet.simps(6) Meet.simps(7) Meet.simps(8) Meet.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Negation.simps(1) Negation.simps(2) Negation.simps(3))
lemma Njoin_polydef: "x \<^bold>\<down> y = x\<^sup>2\<cdot>y\<^sup>2 + 2\<cdot>x\<^sup>2\<cdot>y + 2\<cdot>x\<cdot>y\<^sup>2 + 2\<cdot>x\<cdot>y + 2\<cdot>x + 2\<cdot>y + 1" by (smt (z3) Addition.simps(1) Addition.simps(2) Addition.simps(3) Addition.simps(4) Addition.simps(5) Addition.simps(6) Addition.simps(7) Addition.simps(8) Addition.simps(9) Join.simps(1) Join.simps(2) Join.simps(3) Join.simps(4) Join.simps(5) Join.simps(6) Join.simps(7) Join.simps(8) Join.simps(9) Multiplication.simps(1) Multiplication.simps(2) Multiplication.simps(3) Multiplication.simps(4) Multiplication.simps(5) Multiplication.simps(6) Multiplication.simps(7) Multiplication.simps(8) Multiplication.simps(9) Negation.elims)
